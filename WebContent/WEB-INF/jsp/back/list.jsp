...
<%
	 String path = request.getContextPath(); //相当于 /项目名
...
<body style="background: #e1e9eb;">
		...
		<div class="right">
			...
			<div class="rightCont">
				<p class="g_title fix">内容列表 
				    <a class="btn03" href="<%=basepath%>addPage.action">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="btn03" href="javascript:deleteBatch('<%=basepath%>');" onclick="javascript:return isSelect()">删除</a>
				</p>
				<table class="tab1">
					<tbody>
						<tr>
							...
							<td><input name="command" type="text" class="allInput"
								value="${command}" autocomplete="off" /></td>
							<td width="90" align="right">描述：</td>
							<td><input name="description" type="text" class="allInput"
								value="${description}" autocomplete="off" /></td>
						...
						<tbody>
							...
							<c:forEach items="${messageList}" var="message" varStatus="status">
								<tr
									...
									<td> <a href="<%=basepath%>DeleteOneServlet.action?id=${message.id}" onclick="return confirm('你确定要删除该条信息？');">删除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
	<div class='page fix'>
							...
							跳至&nbsp;<input id="currentPageText" type='text' value='${page.currentPage}' class='allInput w28' autocomplete="off"/>&nbsp;页&nbsp;
